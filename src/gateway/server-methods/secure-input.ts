 ...
 */
const secureInputCreate: GatewayRequestHandler = async ({ params, respond }) => {
 ...
 */
const secureInputSubmit: GatewayRequestHandler = async ({ params, respond }) => {
...
/**
 * Create the secure-input RPC handlers for the gateway WS server.
 */
export function createSecureInputHandlers(): GatewayRequestHandlers {
  return {
    "secure-input.create": secureInputCreate,
    "secure-input.submit": secureInputSubmit,
  };
}
